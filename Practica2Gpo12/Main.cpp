...
//-Grupo:12-------------------------------------------------
//-Alumno:Rosales Velazquez Victor Daniel-------------------
//-NoDeCuenta: 313287480------------------------------------
//Home Alone House -----------------------------------------
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "HomeAlone", nullptr, nullptr);
	...
	Model House((char*)"Models/HomeAlone/house.obj");
	Model Pizza((char*)"Models/CheesePizza/pizza.obj");
	Model PizzaTop((char*)"Models/CheesePizza/pizzaTop.obj");
	Model Llanta((char*)"Models/Models/Carro/Wheel.obj");
	Model Carroseria((char*)"Models/Truck1/truck_body.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(2.95f, 2.09f, 16.18f));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		PizzaTop.Draw(lightingShader);

		//Truck
		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		model = glm::translate(model, glm::vec3(-47.5f + movx, 0.3f, -48.0f + movz)); // Translate it down a bit so it's at the center of the scene
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-47.5f + movx, 0.0f, -48.0f + movz)); // Translate it down a bit so it's at the center of the scene
		model = glm::rotate(model, glm::radians(rotvehiculo), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(0.8f, 0.33f, 1.55f)); // Translate it down a bit so it's at the center of the scene
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-47.5f + movx, 0.0f, -48.0f + movz));
		model = glm::rotate(model, glm::radians(rotvehiculo), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(-1.4f, 0.33f, 1.55f)); // Translate it down a bit so it's at the center of the scene
		...
		model = glm::translate(model, glm::vec3(-47.5f + movx, 0.0f, -48.0f + movz));
		model = glm::rotate(model, glm::radians(rotvehiculo), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(-1.4f, 0.33f, -1.3f));
		...
		model = glm::translate(model, glm::vec3(-47.5f + movx, 0.0f, -48.0f + movz));
		model = glm::rotate(model, glm::radians(rotvehiculo), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(0.8f, 0.33f, -1.3f)); // Translate it down a bit so it's at the center of the scene
		model = glm::rotate(model, glm::radians(rot), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform1f(glGetUniformLocation(lightingShader.Program, "activatransparencia"), 0);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Llanta.Draw(lightingShader);
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(tmp, glm::vec3(95.00f, 0.50f, 30.00f));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(tmp, glm::vec3(95.00f, 0.50f, 30.3f));
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::rotate(model, glm::radians(rotk), glm::vec3(0.0f, 1.0f, 0.0));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(tmp, glm::vec3(95.00f, 0.50f, 29.5f));
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(tmp, glm::vec3(95.10f, 1.74f, 29.35f));
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::rotate(model, glm::radians(rotk), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(-rotBrDer), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(tmp, glm::vec3(95.100f, 1.75f, 30.51f));
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::rotate(model, glm::radians(rotk), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(-rotBrIzq), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(tmp, glm::vec3(95.28f, 1.82f, 30.00f));
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::rotate(model, glm::radians(rotk), glm::vec3(0.0f, 1.0f, 0.0f));
